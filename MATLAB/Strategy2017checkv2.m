...
max_time = 37.5*60; % mins*(seconds/mins) safety factor from 39 mins
...
theta = readtable('theta_quadratic.txt'); %gradient around the track (10 laps)
...
elevation = readtable('elevation_quadratic.txt'); %m Single lap
