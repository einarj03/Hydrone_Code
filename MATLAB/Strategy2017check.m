...
%2017 Track
track_length = 1658.996; %m 
no_laps = 10;
total_length = track_length * no_laps; %m
max_time = 39*60; % mins*(seconds/mins) safety factor from 39 mins
...
theta = readtable('theta_2.txt'); %gradient around the track (10 laps)
...
s = 1;%m Resolution. %1m, 0.1m, 0.01m (or less x 0.1)
